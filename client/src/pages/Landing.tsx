      ...
      <div className="relative z-10 w-full max-w-2xl px-4 py-12">
        <div className="text-center space-y-8 animate-fade-in">
          ...
          <div className="space-y-4">
            <h1 className="text-4xl md:text-6xl font-serif font-bold text-foreground leading-tight" data-testid="heading-hero">
              E se o amor da sua vida já tivesse um rosto?
            </h1>
            
            <p className="text-lg md:text-xl text-muted-foreground max-w-xl mx-auto" data-testid="text-description">
          ...
          <Card className="backdrop-blur-xl bg-card/40 border-primary/20 p-6 max-w-md mx-auto">
            ...
            <Button 
              size="lg" 
              className="w-full h-14 text-lg font-semibold rounded-full bg-gradient-to-r from-primary to-chart-2 hover:opacity-90 transition-opacity"
              onClick={onStart}
