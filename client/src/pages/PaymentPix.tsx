    ...
    <div className="min-h-screen flex items-center justify-center relative p-4">
      ...
      <div className="relative z-10 w-full max-w-2xl animate-fade-in">
        <div className="text-center mb-8">
          ...
          />
          <h2 className="text-2xl md:text-3xl font-serif font-bold text-foreground mb-2" data-testid="heading-payment">
            Pagamento via PIX
          </h2>
        ...
        <Card className="backdrop-blur-xl bg-card/60 border-primary/20 p-8">
          <div className="text-center mb-6">
            <div className="inline-flex items-center gap-2 bg-primary/20 px-6 py-3 rounded-full mb-4">
          ...
          <div className="space-y-6">
            <div className="bg-white p-6 rounded-2xl flex justify-center" data-testid="qr-code-container">
              {qrCodeBase64 ? (
                <img 
                  src={qrCodeBase64} 
                  alt="QR Code PIX" 
                ...
                <div className="w-64 h-64 bg-muted/20 flex items-center justify-center" data-testid="qr-code-placeholder">
            ...
            <div className="space-y-3">
              <div className="text-center text-sm text-muted-foreground" data-testid="text-pix-instructions">
                Ou copie o código PIX:
              </div>
              
              <div className="bg-background/50 border border-border/50 rounded-lg p-4 break-all text-xs font-mono text-muted-foreground" data-testid="text-pix-code">
                {pixCode}
              </div>
            ...
            <div className="bg-primary/10 rounded-lg p-4 text-center" data-testid="status-waiting">
